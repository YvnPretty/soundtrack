...
function ft(n) {
  ...
  var i2 = lt.apply(void 0, __spreadArray([n], r2, false)), a2 = "sc-global-".concat(z(JSON.stringify(i2))), c2 = new ht(i2, a2);
  P(a2);
  var l2 = function(e) {
...
function yt(e) {
  var n = import_react.default.forwardRef(function(n2, r2) {
    ...
    return void 0 === s2 && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "'.concat(B(e), '"')), import_react.default.createElement(e, __assign(__assign({}, n2), { theme: s2, ref: r2 }));
  });
